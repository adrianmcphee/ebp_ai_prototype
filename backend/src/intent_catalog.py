...
BANKING_INTENTS = {
    ...
    "payments.transfer.internal": BankingIntent(
        ...
        description="Transfer between own accounts or navigate to transfers hub",
        confidence_threshold=0.95,
        risk_level=RiskLevel.MEDIUM,
        auth_required=AuthLevel.FULL,
        required_entities=[],
        optional_entities=["amount", "from_account", "to_account", "memo", "schedule_date"],
        example_utterances=[
    ...
    "international.wire.send": BankingIntent(
        ...
        auth_required=AuthLevel.CHALLENGE,
        required_entities=[],
        optional_entities=["amount", "recipient_country", "swift_code", "recipient_account", "purpose", "correspondent_bank"],
        example_utterances=[
